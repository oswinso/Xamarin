package caloriecaculator.caloriecaculator;
...
public class TrialSplashScreen__ extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen__.this, md5f8dbe1d3b9f8d848fa7cf400f13a326a.SearchByNameActivity.class);
